...
class LPiece extends Piece {
  ...
  void rotate() {
    ...
    switch (rotateKind % 4) {
      case 0:
        temp = [
          PieceImpl(x: drawPieces[0].x + 1, y: drawPieces[0].y - 2),
          PieceImpl(x: drawPieces[1].x, y: drawPieces[1].y - 1),
          PieceImpl(x: drawPieces[2].x - 1, y: drawPieces[2].y),
          PieceImpl(x: drawPieces[3].x, y: drawPieces[3].y + 1),
        ];

        break;
      case 1:
        temp = [
          PieceImpl(x: drawPieces[0].x + 2, y: drawPieces[0].y + 1),
          PieceImpl(x: drawPieces[1].x + 1, y: drawPieces[1].y),
          PieceImpl(x: drawPieces[2].x, y: drawPieces[2].y - 1),
          PieceImpl(x: drawPieces[3].x - 1, y: drawPieces[3].y),
        ];
        break;
      case 2:
        temp = [
